...
class User extends Entity
{
    ...
    public function getQRCode()
    {
        ...
        return (new QRCode($options))->render(json_encode($credentials));
    }
     ...
     * @throws Exception
     */
    public function upload(string $fieldName, array $allowedExtensions = ['png', 'jpg', 'jpeg', 'gif', 'aac', '3gp', 'amr', 'mp3', 'm4a', 'wav', 'mp4']): array
    {
        $attachments = [];
