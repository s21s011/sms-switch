...
In the above example, the system will replace %name% with data from the Name column. You must have Name column in your Excel file for it to work.',
    ...
    'faqs' => 'FAQs',
    'support' => 'Support',
    'faqs_link' => 'You can find frequently asked questions from <a target="_blank" href="https://support.your-company.example/knowledgebase/355">here</a>.',
    'support_link' => 'If FAQs doesn\'t resolve the issue you are experiencing then you can open a support ticket from <a target="_blank" href="https://support.your-company.example">here</a>.',
    'cron_job_instructions' => 'Add a cron job by executing below command in linux shell. If you are using the Cpanel or Vesta Panel then follow a guide from <a target="_blank" href="https://smsgateway.your-company.example/docs/setting_up_the_cron_job_1.htm">here</a> to setup a cron job.',
