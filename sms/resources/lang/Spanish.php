...
En el ejemplo anterior, el sistema reemplazará %name% con los datos de la columna Nombre. Debes tener la columna Nombre en tu archivo de Excel para que funcione.',
    ...
    'support' => 'Soporte',
    'faqs_link' => 'Puedes encontrar preguntas frecuentes en <a target="_blank" href="https://support.your-company.example/knowledgebase/355">este enlace</a>.',
    'support_link' => 'Si las preguntas frecuentes no resuelven el problema que estás experimentando, puedes abrir un ticket de soporte en <a target="_blank" href="https://support.your-company.example">este enlace</a>.',
    'cron_job_instructions' => 'Agrega una tarea cron ejecutando el siguiente comando en la terminal de Linux. Si estás utilizando Cpanel o Vesta Panel, sigue una guía en <a target="_blank" href="https://smsgateway.your-company.example/docs/setting_up_the_cron_job_1.htm">este enlace</a> para configurar una tarea cron.',
