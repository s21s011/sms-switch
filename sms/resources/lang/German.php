...
Im obigen Beispiel ersetzt das System %name% durch Daten aus der Spalte Name. Sie müssen die Spalte Name in Ihrer Excel-Datei haben, damit dies funktioniert.',
    ...
    'debug' => 'Debuggen',
    'username' => 'Nutzername',
    'application_copyright' => '<strong>Copyright &copy; 2018-%present% <a href="%url%" id="company_url">%name%</a></strong>. Alle Rechte vorbehalten.',
    ...
    'faqs_link' => '<a target="_blank" href="https://support.your-company.example/knowledgebase/355">Hier</a> finden Sie häufig gestellte Fragen.',
    'support_link' => 'Wenn FAQs das aufgetretene Problem nicht beheben, können Sie von <a target="_blank" href="https://support.your-company.example">hier</a> aus ein Support-Ticket öffnen.',
    'cron_job_instructions' => 'Fügen Sie einen Cron-Job hinzu, indem Sie den folgenden Befehl in der Linux-Shell ausführen. Wenn Sie das Cpanel- oder Vesta-Panel verwenden, befolgen Sie eine Anleitung von <a target="_blank" href="https://smsgateway.your-company.example/docs/setting_up_the_cron_job_1.htm">hier</a> aus, um einen Cron-Job einzurichten.',
